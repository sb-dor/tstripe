...
/// {@template payment_web_widget}
/// Payment UI for Flutter Web.
///
/// Stripe.js must be loaded via index.html before this widget is shown.
/// Uses the same [Stripe.instance.initPaymentSheet] /
/// [Stripe.instance.presentPaymentSheet] API as mobile.
/// {@endtemplate}
class PaymentWebWidget extends StatelessWidget {
  /// {@macro payment_web_widget}
  const PaymentWebWidget({super.key});
      ...
      onClientSecret: (clientSecret) async {
        await Stripe.instance.initPaymentSheet(
          paymentSheetParameters: SetupPaymentSheetParameters(
            ...
            // returnURL is not needed on web — Stripe.js handles redirects.
          ),
        );
