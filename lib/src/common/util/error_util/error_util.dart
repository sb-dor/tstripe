...
import 'package:tstripe/src/common/util/error_util/platform/error_util_vm.dart'
    if (dart.library.html) 'package:tstripe/src/common/util/error_util/platform/error_util_js.dart';
